...
{
    public class GetPropertiesWithTypeParameter_Should
    {
        [Theory]
        ...
        public void BeEqualToGetPropertiesOfType<T>(T type)
        {
            // arrange
            // act
            var properties = SUT.PropertyCache.GetProperties(typeof(T));
            // assert
        ...
        public void BeEqualToExpected<T>(T type, PropertyInfo[] properties)
        {
            // arrange
            // act
            var result = SUT.PropertyCache.GetProperties(typeof(T));
            // assert
